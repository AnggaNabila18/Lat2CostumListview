package com.example.lat2costumlistview;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heroList.add(new Hero(R.drawable.joker, "Joker", "Injustice Geng"));
        ...
        heroList.add(new Hero(R.drawable.batman, "Batman", "Injustice Geng"));
